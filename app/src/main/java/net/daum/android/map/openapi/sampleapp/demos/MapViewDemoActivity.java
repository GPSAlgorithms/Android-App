...
public class MapViewDemoActivity extends FragmentActivity
    ...
    private void controlMapMove(int which) {
        switch (which) {
            case 0: // Move to
            {
                mMapView.setMapCenterPoint(MapPoint.mapPointWithGeoCoord(36.33735305, 127.44742394), true);
            }
            break;
            case 1: // Zoom to
            {
    ...
    public void onMapViewInitialized(MapView mapView) {
        ...
        mapView.setMapCenterPointAndZoomLevel(MapPoint.mapPointWithGeoCoord(36.33735305,127.44742394), 2, true);
    }
